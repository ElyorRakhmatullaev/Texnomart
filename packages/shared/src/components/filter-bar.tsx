...
export function FilterBar({
  ...
  return (
    <div
      className={cn(
        "flex items-center gap-2 flex-wrap shrink-0 bg-gray-50 dark:bg-muted rounded-md px-3 py-2",
        className
      )}
    >
      {filters.map((filter) => (
        ...
        >
          <SelectTrigger className="w-[160px] h-8 text-sm bg-white dark:bg-input-background">
