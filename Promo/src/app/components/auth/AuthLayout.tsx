    ...
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-[60%] bg-primary flex-col p-12 relative">
        ...
        <div className="flex-1 flex flex-col items-center justify-center text-center px-8">
          <CalendarRange className="size-24 text-black mb-8" strokeWidth={1.5} />
          <h1 className="text-4xl font-bold text-black mb-4">Промо-календарь</h1>
          <p className="text-lg text-gray-900 max-w-md">
            Планирование и согласование плановых и внеплановых промо-акций
          </p>
        </div>
