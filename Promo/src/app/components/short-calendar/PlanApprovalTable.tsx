...
const HEAD =
  "px-3 py-2 text-left align-bottom border-b bg-gray-50 text-[13px] font-semibold text-gray-700";
const CELL = "px-3 py-3 align-top border-b border-gray-100";
            ...
            {rows.map((r) => {
              ...
              return (
                <tr key={r.id} className="hover:bg-gray-50/60">
                  ...
                  <td className={cn(CELL, "text-gray-600")}>{r.type}</td>
                  <td className={cn(CELL, "font-medium text-gray-900")}>
                    {r.name}
                  </td>
                  <td className={cn(CELL, "tabular-nums text-gray-700")}>
        ...
        {rows.map((r) => {
          ...
          return (
            <div key={r.id} className="rounded-lg border bg-white p-3">
              ...
              <div className="mt-0.5 font-medium text-gray-900">{r.name}</div>
