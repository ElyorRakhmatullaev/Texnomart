...
/**
 * Не-ключевые действия — скрыты по умолчанию, видны только в режиме «Все действия»
 * (Администратор). 5C, вкладка 4 пп. 3–4: помимо черновиков/редактирования/автосохранения
 * сюда относятся ТЕХНИЧЕСКИЕ и АДМИНИСТРАТИВНЫЕ действия над учётными записями —
 * раньше они попадали в «Ключевые» и забивали ленту согласований.
 */
