    ...
    <Popover>
      <PopoverTrigger asChild>
        <button
          ...
          className={cn(
            ...
            "size-6 shrink-0 text-muted-foreground hover:text-gray-900"
          )}
        >
      ...
      <PopoverContent align="end" className="w-72 p-0">
        <div className="border-b px-3 py-2">
          <p className="text-sm font-semibold text-gray-900">Остаток по складам</p>
        ...
        <ul className="divide-y">
          {rows.map((r) => (
            ...
            >
              <span className="truncate text-gray-700">{r.warehouse}</span>
        ...
        <div className="flex items-center justify-between gap-3 border-t bg-gray-50 px-3 py-2 text-sm font-semibold">
