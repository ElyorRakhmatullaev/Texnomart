...
export const CATEGORY_MANAGERS: CategoryManager[] = [
  { id: "km-1", name: "Алиев Бекзод", category: "Аудио и видео техника, геймерские товары" },
  { id: "km-2", name: "Юсупова Нигора", category: "Крупно-бытовая техника для кухни" },
  { id: "km-3", name: "Каримов Шерзод", category: "Персональная электроника" },
  { id: "km-4", name: "Рашидова Дилноза", category: "Мелко-бытовая техника для кухни" },
  { id: "km-5", name: "Тошматов Фаррух", category: "Техника для офиса, умный дом, компьютеры и периферия" },
  { id: "km-6", name: "Исмаилов Жасур", category: "Климатическая техника и техника для ухода за домом", senior: true },
];
...
// ~30 SKUs, generated deterministically (no randomness). Categories are the nine
// agreed ones (`PROMO_CATEGORIES` in distribution-store.ts); an item takes the
// category that fits it, not necessarily its КМ's home category.
...
const NOMENCLATURE_SEED: Array<[string, string, string, number, number, number]> = [
  ["Samsung QLED 55\" QE55Q60D", "Аудио и видео техника, геймерские товары", "Samsung", 6200000, 8990000, 42],
  ["LG OLED 48\" OLED48C4", "Аудио и видео техника, геймерские товары", "LG", 8100000, 11490000, 18],
  ["Saund-бар Samsung HW-B650", "Аудио и видео техника, геймерские товары", "Samsung", 2100000, 3290000, 60],
  ["Artel ТВ 43\" 43H3401", "Аудио и видео техника, геймерские товары", "Artel", 1900000, 2790000, 75],
  ["Xiaomi TV A2 50\"", "Аудио и видео техника, геймерские товары", "Xiaomi", 3100000, 4490000, 33],
  ["Холодильник Artel HD 455", "Крупно-бытовая техника для кухни", "Artel", 3900000, 5690000, 28],
  ["Samsung RB37 No Frost", "Крупно-бытовая техника для кухни", "Samsung", 5600000, 7990000, 15],
  ["LG GC-B247 Side-by-Side", "Крупно-бытовая техника для кухни", "LG", 9800000, 13990000, 9],
  ["Стиральная машина Bosch WGG", "Климатическая техника и техника для ухода за домом", "Bosch", 4700000, 6790000, 21],
  ["Посудомоечная Midea MFD45", "Крупно-бытовая техника для кухни", "Midea", 3300000, 4790000, 17],
  ["iPhone 15 128GB", "Персональная электроника", "Apple", 9900000, 12990000, 40],
  ["Samsung Galaxy S24 256GB", "Персональная электроника", "Samsung", 9100000, 11990000, 35],
  ["Xiaomi Redmi Note 13 Pro", "Персональная электроника", "Xiaomi", 2600000, 3590000, 88],
  ["Realme 12 Pro 8/256", "Персональная электроника", "Realme", 2900000, 3990000, 52],
  ["Наушники Apple AirPods Pro 2", "Персональная электроника", "Apple", 2300000, 3290000, 64],
  ["Пылесос Dyson V12", "Климатическая техника и техника для ухода за домом", "Dyson", 4200000, 5990000, 12],
  ["Кофемашина De'Longhi Magnifica", "Мелко-бытовая техника для кухни", "De'Longhi", 3600000, 5290000, 14],
  ["Мультиварка Redmond RMC", "Мелко-бытовая техника для кухни", "Redmond", 620000, 990000, 130],
  ["Утюг Philips Azur", "Мелко-бытовая техника для дома, уход за одеждой, красота и здоровье", "Philips", 480000, 749000, 110],
  ["Блендер Bosch ErgoMixx", "Мелко-бытовая техника для кухни", "Bosch", 390000, 599000, 95],
  ["Ноутбук ASUS Vivobook 15", "Техника для офиса, умный дом, компьютеры и периферия", "ASUS", 5400000, 7490000, 22],
  ["MacBook Air M3 13\"", "Техника для офиса, умный дом, компьютеры и периферия", "Apple", 13200000, 16990000, 7],
  ["Lenovo IdeaPad Slim 3", "Техника для офиса, умный дом, компьютеры и периферия", "Lenovo", 4100000, 5790000, 30],
  ["Монитор Samsung 27\" T35F", "Техника для офиса, умный дом, компьютеры и периферия", "Samsung", 1600000, 2390000, 44],
  ["ПК HP Pavilion Desktop", "Техника для офиса, умный дом, компьютеры и периферия", "HP", 6800000, 9290000, 11],
  ["Кондиционер Artel 12000 BTU", "Климатическая техника и техника для ухода за домом", "Artel", 2700000, 3890000, 48],
  ["Кондиционер Gree Bora 09", "Климатическая техника и техника для ухода за домом", "Gree", 3100000, 4490000, 26],
  ["Обогреватель Ballu BIH", "Климатическая техника и техника для ухода за домом", "Ballu", 540000, 849000, 140],
  ["Увлажнитель Xiaomi Smart", "Климатическая техника и техника для ухода за домом", "Xiaomi", 720000, 1090000, 80],
  ["Вентилятор Centek CT-5015", "Климатическая техника и техника для ухода за домом", "Centek", 280000, 449000, 160],
];
...
export const CAMPAIGNS: PromoCampaign[] = [
  {
    ...
    categoryDistribution: [
      { date: new Date(2026, 10, 27), category: "Аудио и видео техника, геймерские товары", responsibleKmId: "km-1" },
      { date: new Date(2026, 10, 27), category: "Крупно-бытовая техника для кухни", responsibleKmId: "km-2" },
      { date: new Date(2026, 10, 28), category: "Персональная электроника", responsibleKmId: "km-3" },
      { date: new Date(2026, 10, 30), category: "Климатическая техника и техника для ухода за домом", responsibleKmId: "km-6" },
    ],
  ...
  },
  {
    ...
    categoryDistribution: [
      { date: new Date(2026, 11, 15), category: "Крупно-бытовая техника для кухни", responsibleKmId: "km-2" },
      { date: new Date(2026, 11, 15), category: "Техника для офиса, умный дом, компьютеры и периферия", responsibleKmId: "km-5" },
      { date: new Date(2026, 11, 20), category: "Мелко-бытовая техника для кухни", responsibleKmId: "km-4" },
    ],
    planStatus: "Утверждён",
  },
  {
    ...
    categoryDistribution: [
      { date: new Date(2026, 9, 1), category: "Мелко-бытовая техника для кухни", responsibleKmId: "km-4" },
    ],
    planStatus: "Утверждён",
  },
  {
  ...
  },
  {
    ...
    categoryDistribution: [
      { date: new Date(2026, 5, 22), category: "Персональная электроника", responsibleKmId: "km-3" },
      { date: new Date(2026, 6, 1), category: "Техника для офиса, умный дом, компьютеры и периферия", responsibleKmId: "km-5" },
    ],
    planStatus: "Утверждён",
  },
  ...
  // full taxonomy so the readiness bar + «Статус КМ по акции» filter show variety.
  {
    ...
    categoryDistribution: [
      { date: new Date(2026, 8, 10), category: "Аудио и видео техника, геймерские товары", responsibleKmId: "km-1" },
      { date: new Date(2026, 8, 12), category: "Техника для офиса, умный дом, компьютеры и периферия", responsibleKmId: "km-5" },
    ],
    planStatus: "Утверждён",
  },
  {
    ...
    categoryDistribution: [
      { date: new Date(2026, 9, 5), category: "Крупно-бытовая техника для кухни", responsibleKmId: "km-2" },
      { date: new Date(2026, 9, 7), category: "Климатическая техника и техника для ухода за домом", responsibleKmId: "km-6" },
    ],
    planStatus: "Утверждён",
  },
  {
  ...
  },
  {
    ...
    categoryDistribution: [
      { date: new Date(2026, 6, 1), category: "Крупно-бытовая техника для кухни", responsibleKmId: "km-2" },
      { date: new Date(2026, 6, 1), category: "Аудио и видео техника, геймерские товары", responsibleKmId: "km-1" },
    ],
    planStatus: "Утверждён",
  },
  {
    ...
    categoryDistribution: [
      { date: new Date(2026, 7, 1), category: "Техника для офиса, умный дом, компьютеры и периферия", responsibleKmId: "km-5" },
    ],
    planStatus: "Утверждён",
  },
  {
  ...
  },
  {
    ...
    categoryDistribution: [
      { date: new Date(2026, 11, 1), category: "Мелко-бытовая техника для кухни", responsibleKmId: "km-4" },
      { date: new Date(2026, 11, 3), category: "Крупно-бытовая техника для кухни", responsibleKmId: "km-2" },
    ],
    planStatus: "Утверждён",
  },
  {
    ...
    categoryDistribution: [
      { date: new Date(2026, 11, 20), category: "Аудио и видео техника, геймерские товары", responsibleKmId: "km-1" },
      { date: new Date(2026, 11, 20), category: "Крупно-бытовая техника для кухни", responsibleKmId: "km-2" },
      { date: new Date(2026, 11, 22), category: "Техника для офиса, умный дом, компьютеры и периферия", responsibleKmId: "km-5" },
    ],
    planStatus: "Утверждён",
  },
  {
...
export function buildNotifications(ref: Date = new Date()): PromoNotification[] {
  ...
  return [
    ...
    },
    {
      ...
      description: "Вы назначены категорийным менеджером по направлению «Крупно-бытовая техника для кухни».",
    ...
    },
    {
      ...
      actor: { name: "Сардор Мавлянов", role: "Коммерческий директор" },
      description: "Назначен КМ Каримов Шерзод по направлению «Персональная электроника».",
      sentAt: daysAgo(2),
      read: true,
      href: "/full-calendar",
...
const AUDIT_EVENTS_SEED: Omit<AuditEvent, "id">[] = [
  ...
  },
  {
    ...
    action: "Не участвует",
    objectType: "акция",
    objectLabel: "Чёрная пятница 2026 — климатическая техника и техника для ухода за домом",
    campaignId: "PR-2026-001",
    statusFrom: "На согласовании у старшего КМ",
