...
export const CAPABILITIES: Capability[] = [
  ...
  {
    id: "manage-users-dept",
    label: "Управление пользователями (в подразделении)",
    description: "То же управление учётками, но ограниченное подразделением; охватывает и «Администратора подразделения» — это area-скоуп конкретного пользователя, а не отдельная роль.",
    group: "Пользователи и доступ",
    enforcedIn: "adminScope · canManageUser · E-4",
    allowed: (r) => r === "Администратор",
  },
  {
    id: "assign-kd-substitute",
    label: "Назначение уполномоченного лица КД",
    description: "Назначение сотрудника, временно замещающего коммерческого директора в согласовании.",
    group: "Пользователи и доступ",
    enforcedIn: "KdSubstitutionPanel · E-4",
    allowed: (r) => r === "Администратор" || r === "Коммерческий директор",
  },
  {
    id: "act-kd-substitute",
    label: "Действие в качестве уполномоченного лица КД",
    description: "Выполнение финального согласования от имени КД в период замещения; в моке право действовать определяется тем, что именно вошедший пользователь назначен уполномоченным лицом (не самой ролью).",
    group: "Пользователи и доступ",
