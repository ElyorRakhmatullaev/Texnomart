...
export const dashboardShellConfig: AppShellConfig = {
  ...
  navGroups: [
    {
      items: [
        ...
        { label: "Заявки", icon: FileText, href: "/applications", badge: 12, badgeVariant: "default" },
        ...
        { label: "Уведомления", icon: Bell, href: "/notifications", badge: 3, badgeVariant: "destructive" },
      ],
    },
    {
      label: "Система",
  ...
  breadcrumbRoutes: [
    { path: "/", label: "Дашборд" },
    { path: "/dashboard/:metricId", label: "Метрика", parent: "/", paramLabel: (id) => {
    ...
    { path: "/applications/:id", label: "Заявка", parent: "/applications", paramLabel: (id) => `Заявка ${id}` },
    { path: "/analytics", label: "Аналитика" },
    { path: "/clients", label: "Клиенты" },
    { path: "/clients/:id", label: "Клиент", parent: "/clients", paramLabel: (id) => `Клиент ${id}` },
    { path: "/partners", label: "Партнёры" },
    { path: "/partners/:id", label: "Партнёр", parent: "/partners", paramLabel: (id) => `Партнёр ${id}` },
    { path: "/branches", label: "Филиалы" },
    { path: "/branches/:id", label: "Филиал", parent: "/branches", paramLabel: (id) => `Филиал ${id}` },
    { path: "/users", label: "Пользователи" },
    { path: "/users/:id", label: "Пользователь", parent: "/users", paramLabel: (id) => `Пользователь ${id}` },
    { path: "/telegram", label: "Telegram-бот" },
    { path: "/notifications", label: "Уведомления" },
    { path: "/audit", label: "Аудит" },
    { path: "/audit/:id", label: "Запись", parent: "/audit", paramLabel: (id) => `Запись ${id}` },
