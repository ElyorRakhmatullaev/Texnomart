...
| **Client Broker** | `Broker/` | Client Broker — операторское приложение скоринга в магазине (ветка Alif: привязка карты → доп. данные → подтверждение кредита → успех) | Active — Alif flow (экраны 2–6) complete (2026-08-17) |
...
- `Broker/CLAUDE.md` — Client Broker routes, mock conventions, Alif flow state (Alif flow — экраны 2–6 — complete)
